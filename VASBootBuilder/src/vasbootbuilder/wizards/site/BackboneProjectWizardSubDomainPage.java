...
public class BackboneProjectWizardSubDomainPage extends WizardPage {
	private Text textSampleDomainClass;
	private Table table;
	private Combo comboParentDomain;
	...
	public BackboneProjectWizardSubDomainPage(String pageName) {
		super(pageName);
		setTitle("Sample SubDomain Class");
		setDescription("Create a sample subdomain class");		
	}
	...
	public void createControl(Composite parent) {
		...
		Label lblParentLabel = new Label(container, SWT.NONE);
		lblParentLabel.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
		lblParentLabel.setText("Parent Domain Class:");
		new Label(container, SWT.NONE);
		comboParentDomain = new Combo(container, SWT.BORDER);
		comboParentDomain.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		for(String item: additionalTypes) {
			comboParentDomain.add(item);
		}
	...
	private void validatePackage(String className){			
		if(className.trim().length() == 0){
			updateStatus("Please specify a Class name For the SubDomain");
			return;			
		}		
	...
	public String getClassSource(Map<String, Object> values) throws Exception{
		...
		*/
		...
		InputStream is = 
				TemplateMerger.merge("/vasbootbuilder/resources/java/class.java-template", mapOfValues);
	...
	public String getListWrapperSourceCode(String basePackageName, 
		...
		InputStream is = 
				TemplateMerger.merge("/vasbootbuilder/resources/java/listWrapper.java-template", valuesToPlug);
	...
	public String getNameValueSourceCode(String basePackageName, 
		...
		valuesToPlug.put("commonPackageName", commonPackageName);
		InputStream is = 
				TemplateMerger.merge("/vasbootbuilder/resources/java/name-value.java-template", valuesToPlug);
	...
	public String getMessageBundleContent(String basePackageName, String commonPackageName,String domainClassName)
		...
		Map<String, Object> valuesToPlug = new LinkedHashMap<String, Object>();		
		InputStream is = 
				TemplateMerger.merge("/vasbootbuilder/resources/java/messages_en.properties", valuesToPlug);
	...
	public String getMessageBundleContentEs(String basePackageName, String commonPackageName,String domainClassName)
		...
		Map<String, Object> valuesToPlug = new LinkedHashMap<String, Object>();		
		InputStream is = 
				TemplateMerger.merge("/vasbootbuilder/resources/java/messages_es.properties", valuesToPlug);
	...
	public String getParentDomainName() {
		String fullName = this.comboParentDomain.getText();
