...
define([        
 ...
 'globals/global'
	...
	var AppRouter = Backbone.Router.extend({		
		routes: {
		#parse("/vasbootbuilder/resources/web/js/backbone/routers/router-template-fragment-02.js")
		}		
	});
	...
	var initialize = function(){		
	    ...
	    #parse("/vasbootbuilder/resources/web/js/backbone/routers/router-template-fragment-03.js")
